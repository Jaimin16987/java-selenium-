...
public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.name("username")).sendKeys("jaimin005");
...
//		}
		...
		//Method-2:
		driver.findElement(By.xpath("//a[contains(text(),'james bond')]/parent::td//preceding-sibling::td//input[@name='contact_id']")).click();
